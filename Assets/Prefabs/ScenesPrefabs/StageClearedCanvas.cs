...
public class StageClearedCanvas : MonoBehaviour
{
    ...
    void Start()
    {
        SettingStageClearedCanvasAtStart();
    }
    void Update()
    {
    ...
    #endregion
    /// <summary>
    /// Initialisation des variables nécessaires pour le timer, les transitions et le background
    /// </summary>
    private void SettingStageClearedCanvasAtStart()
    {
